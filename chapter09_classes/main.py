...
'''
지금까지 배운 함수와 매개변수, 그리고  argument를 통해 6개의 변수르 처리했습니다. 하지만
만들어야 할 변수의 개수가 많고, 학생 한명당 매개변수가 6개라면, 학생이 100명알 경우 600개의 변수를 처리할 필ㄹ요가 있습니다.
'''
...
#name2, ... ,grade2라는 변수들을 선언하고, 거기에 여러분들의 정보를 입력한 뒤 keyword argument를 통해서 student_info()함수를 호출

name2 = "박주연"
department2 = "전자전기정보공학부"
professor2 = "BAE"
phone2 = "010-6666-6666"
address2 = "부산광역시 해운대구"
grade2 = "F"
...
1. 클래스 정의
    클래스를 작성하는 것을 클래스 정의라고 합니다-> 함수 정의를 생각하심 됩니다,
...
1. 클래스의 기본 구성
    객체를 만들어내느 클래스는 객체가 가져야 할 구성 요소를 지닙니다.
    객체를 생성하기 위해서는 클래스는 객체가 가져야 할 '값'과 '기능'을 지녀야 합니다.
    
    값 = 속성(attribute)
    기능 = 메서드(method)
    
    클래스를 구성하는 변수는 두가지로 구분됩니다.
    ...
    인스턴스 변수 : 클래스를 기반으로 만들어지는 모든 인스턴스들이 각각 따로 저장하는 변술를 의미
